...
def main(input_file, output_file, limit, intents_count, constraints_count, link_words_count, quantifiers_count, scenarios_count, seed=None, debug=False): 
    ...
    for i in range(limit):
        utterance = Utterance(all_scenarios, all_intents, all_constraints, all_link_words, all_quantifiers)
        scenarios, intents, constraints, link_words, quantifiers, min_intents, min_constraints = utterance.sample(intents_count, constraints_count, link_words_count, quantifiers_count, scenarios_count)
