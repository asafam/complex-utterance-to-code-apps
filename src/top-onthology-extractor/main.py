...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, help='dataset path', default='/Users/asaf/Workspace/biu/thesis-swiss-army-knife/data/TOPv2_Dataset/*.tsv')
    parser.add_argument('--outputfile', type=str, help='dataset path', default='./build/onthologies.tsv')
